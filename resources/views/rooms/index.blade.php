...
<div class="md:flex flex-col md:flex-row md:min-h-screen w-full">
  <div class="flex flex-col w-full md:w-64 text-gray-700 bg-white dark-mode:text-gray-200 dark-mode:bg-gray-800 flex-shrink-0" x-data="{ open: false }">
    ...
    <nav :class="{'block': open, 'hidden': !open}" class="flex-grow md:block px-4 pb-4 md:pb-0 md:overflow-y-auto">
      <a class="block px-4 py-2 mt-2 text-sm font-semibold text-gray-900 bg-gray-200 rounded-lg dark-mode:bg-gray-700 dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="#">B&B info</a>
            ...
            <div class="w-full lg:flex mb-2">
                ...
                <div class="border-r border-b border-l border-grey-light lg:border-l-0 lg:border-t lg:border-grey-light bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
                    ...
                    <div class="text-black font-bold text-xl mb-2">
                        <a href="/rooms/{{ $room->id }}" class="hover:bg-yellow-300 hover:underline" >{{ $room->name }}</a>
                    </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div>
                            <a href="/rooms/{{ $room->id }}" class="border-2 border-yellow-300 rounded-lg font-bold px-4 py-3 transition duration-300 ease-in-out hover:bg-yellow-300 hover:text-white mr-6 ml-4">
                            Meer info
                            </a>
                        </div>
                    </div>
